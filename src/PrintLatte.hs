...
instance Print FunDef where
  prt i e = case e of
   FunDef type' id args block -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString "(") , prt 0 args , doc (showString ")") , prt 0 block])


instance Print TopDef where
  prt i e = case e of
   FnDef fundef -> prPrec i 0 (concatD [prt 0 fundef])
   StDef type' atts -> prPrec i 0 (concatD [doc (showString "class") , prt 0 type' , doc (showString "{") , prt 0 atts , doc (showString "}")])
...
instance Print Att where
  prt i e = case e of
   Att type' id -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString ";")])
   Meth fundef -> prPrec i 0 (concatD [prt 0 fundef])

  prtList es = case es of
   [] -> (concatD [])
   x:xs -> (concatD [prt 0 x , prt 0 xs])

instance Print New where
  prt i e = case e of
   NewArr type' expr -> prPrec i 0 (concatD [doc (showString "new") , prt 0 type' , doc (showString "[") , prt 0 expr , doc (showString "]")])
   NewSt type' -> prPrec i 0 (concatD [doc (showString "new") , prt 0 type'])


instance Print Assignable where
  prt i e = case e of
   AIdent id -> prPrec i 0 (concatD [prt 0 id])
   AArr id expr -> prPrec i 0 (concatD [prt 0 id , doc (showString "[") , prt 0 expr , doc (showString "]")])
   AMeth id exprs -> prPrec i 0 (concatD [prt 0 id , doc (showString "(") , prt 0 exprs , doc (showString ")")])
...
instance Print Assign where
  prt i e = case e of
   AList assignables -> prPrec i 0 (concatD [prt 0 assignables])
   ANewDot new assignables -> prPrec i 0 (concatD [doc (showString "(") , prt 0 new , doc (showString ")") , doc (showString ".") , prt 0 assignables])
   ANewArr new expr -> prPrec i 0 (concatD [doc (showString "(") , prt 0 new , doc (showString ")") , doc (showString "[") , prt 0 expr , doc (showString "]")])
...
instance Print Stmt where
  prt i e = case e of
   ...
   Ass assign expr -> prPrec i 0 (concatD [prt 0 assign , doc (showString "=") , prt 0 expr , doc (showString ";")])
   Incr assign -> prPrec i 0 (concatD [prt 0 assign , doc (showString "++") , doc (showString ";")])
   Decr assign -> prPrec i 0 (concatD [prt 0 assign , doc (showString "--") , doc (showString ";")])
   ...
   For type' id expr stmt -> prPrec i 0 (concatD [doc (showString "for") , doc (showString "(") , prt 0 type' , prt 0 id , doc (showString ":") , prt 6 expr , doc (showString ")") , prt 0 stmt])
...
instance Print Type where
  prt i e = case e of
   ...
   Clas id -> prPrec i 0 (concatD [prt 0 id])
...
instance Print Expr where
  prt i e = case e of
   EVar assign -> prPrec i 6 (concatD [prt 0 assign])
   ...
   ENew new -> prPrec i 6 (concatD [prt 0 new])
